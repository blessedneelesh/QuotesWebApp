...
import "./SubNavbarAuthenticated.css";
...
const SubNavbarAuthenticated = ({ onParamChange, paramId }) => {
  ...
  const onchange = (e) => {
    ...
    //navigate("/profile", { state: { id: e.target.value } });
...
export default SubNavbarAuthenticated;
